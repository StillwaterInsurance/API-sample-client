...
public class HomeQuoteH6Test {
	...
	public void homeQuoteH3Test() {
		...
		policyType.setValue("06"); // <-- H6 indicates an Condo
		...
		//		com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.Long long_1 = of.createLong();
		//		long_1.setValue(1);
		...
		final Decimal decimal1 = of.createDecimal();
		decimal1.setValue(new BigDecimal(30000));
		currency.setAmt(decimal1);
		...
		// -------------------------------------------------------------------
		checkH6RequestsForRequiredFields(acordTypeRequest);
		...
		assertTrue("Service call took longer than 60 seconds", end - start < 60000);
	 ...
	 * @param acord
	 */
	public void checkH6RequestsForRequiredFields(final ACORDType acord){
		...
		homePolicyQuoteInqRqType.getInsuredOrPrincipal().get(0).getInsuredOrPrincipalInfo().getContent().get(1).getValue();
