...
import com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.C50;
import com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.C64;
import com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.CURRENCY;
...
import com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.CoverageType2;
...
import com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.LimitType;
...
import com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.NumberOfStories;
...
public class HomeQuoteH4Test {
	...
	public void homeQuoteH4Test() {
		...
		// producerType
		//		C20 c20_1 = of.createC20();
		//		c20_1.setValue("FNF100015");
		//		ProducerInfoType producerInfoType = of.createProducerInfoType();
		//		producerInfoType.setContractNumber(c20_1);
		//		ProducerType producerType = of.createProducerType();
		...
		//		// ItemIdInfoType
		//		ItemIdInfoType itemIdInfoType = of.createItemIdInfoType();
		//		insuredOrPrincipalType.setItemIdInfo(itemIdInfoType);
		//		AssignedIdentifier assignedIdentifier = of.createAssignedIdentifier();
		...
		//		TaxIdentityType taxIdentityType = of.createTaxIdentityType();
		//		nameInfoType.getTaxIdentity().add(taxIdentityType);
		//		TaxIdType taxIdType = of.createTaxIdType();
		//		taxIdType.setValue("SSN");
		//		taxIdentityType.setTaxIdTypeCd(taxIdType);
		//
		//		AssignedIdentifier assignedIdentifier1 = of.createAssignedIdentifier();
		...
		//		OpenEnum openEnum_5 = of.createOpenEnum();
		...
		policyType.setValue("04"); // <-- H4 indicates a Renter
		dwellType.setPolicyTypeCd(policyType);

		//		Date date_3 = of.createDate();
		...
		//		Date date_4 = of.createDate();
		//		date_4.setValue("1993");
		//		constructionType2.setYearBuilt(date_4);

		//		Foundation foundation = of.createFoundation();
		//		foundation.setValue("BS");
		//		constructionType2.setFoundationCd(foundation);

		//		Decimal decimal_1 = of.createDecimal();
		//		decimal_1.setValue(new BigDecimal(2));
		//		constructionType2.setNumStories(decimal_1);

		//		RoofingMaterialType roofingMaterialType = of.createRoofingMaterialType();
		//		RoofMaterialType roofMaterialType = of.createRoofMaterialType();
		...
		residenceType.setValue("APT");
		dwellOccupancyType.setResidenceTypeCd(residenceType);

		//		DwellingUse dwellingUse = of.createDwellingUse();
		...
		//		MEASUREMENT measurement_1 = of.createMEASUREMENT();
		//		Decimal decimal_2 = of.createDecimal();
		//		decimal_2.setValue(new BigDecimal(3));
		//		measurement_1.setNumUnits(decimal_2);
		//		OpenEnum openEnum_6 = of.createOpenEnum();
		...
		//		MEASUREMENT measurement_2 = of.createMEASUREMENT();
		//		Decimal decimal_3 = of.createDecimal();
		//		decimal_3.setValue(new BigDecimal(200));
		//		measurement_2.setNumUnits(decimal_3);
		//		OpenEnum openEnum_7 = of.createOpenEnum();
		...
		//		ProtectionDevice protectionDevice = of.createProtectionDevice();
		...
		protectionDevice_1.setValue("FIRE");
		...
		//		ProtectionDevice protectionDevice_3 = of.createProtectionDevice();
		...
		final NumberOfStories numberOfStories = of.createNumberOfStories();
		numberOfStories.setValue("1");
		dwellInspectionValuationType.setNumStoriesInDwellingCd(numberOfStories);

		//		BathroomInfoType bathroomInfoType = of.createBathroomInfoType();
		//		dwellInspectionValuationType.getBathroomInfo().add(bathroomInfoType);
		//		com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.Long long_2 = of.createLong();
		//		long_2.setValue(1);
		//		bathroomInfoType.setNumBathrooms(long_2);
		//		ConstructionClass constructionClass = of.createConstructionClass();
		//		constructionClass.setValue("Basic");
		//		bathroomInfoType.setConstructionQualityCd(constructionClass);

		//		FireplaceInfoType fireplaceInfoType = of.createFireplaceInfoType();
		//		dwellInspectionValuationType.getFireplaceInfo().add(fireplaceInfoType);
		//		com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.Long long_3 = of.createLong();
		//		long_3.setValue(1);
		//		fireplaceInfoType.setNumFireplaces(long_3);

		//		GarageInfoType garageInfoType = of.createGarageInfoType();
		//		dwellInspectionValuationType.getGarageInfo().add(garageInfoType);
		//		GarageType garageType = of.createGarageType();
		//		garageType.setValue("BS");
		//		garageInfoType.setGarageTypeCd(garageType);

		//		com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.Boolean boolean_2 = of.createBoolean();
		//		boolean_2.setValue(true);
		//		garageInfoType.setAttachedInd(boolean_2);

		//		com.stillwaterinsurance.api.client.acord.homeQuoteV1_0.Long long_4 = of.createLong();
		//		long_4.setValue(1);
		//		garageInfoType.setNumGarages(long_4);

		//		KitchenInfoType kitchenInfoType = of.createKitchenInfoType();
		//		ConstructionClass constructionClass_1 = of.createConstructionClass();
		...
		// start Coverage
		final CoverageType2 coverageType2 = of.createCoverageType2();
		dwellType.getCoverage().add(coverageType2);

		final C50 c50 = of.createC50();
		c50.setValue("RCC");
		coverageType2.setCoverageCd(c50);

		final LimitType limitType = of.createLimitType();
		final CURRENCY currency = of.createCURRENCY();
		final Decimal decimal_1 = of.createDecimal();
		decimal_1.setValue(new BigDecimal(30000));
		currency.setAmt(decimal_1);
		limitType.setFormatCurrencyAmt(currency);
		coverageType2.getLimit().add(limitType);
		// end Coverage
		...
		// -------------------------------------------------------------------
		checkH4RequestsForRequiredFields(acordTypeRequest);
	 ...
	 *
	 * https://api-qua.stillwaterinsurance.com/api-docs/page?id=faqs-home-quote-1-0-h4
	 *
	 * @param acord
	 */
	public void checkH4RequestsForRequiredFields(final ACORDType acord){

		//TODO This validation method is not 100% complete.  We still need
		//to research the fields that are required by the backend.
